...
namespace baitaptrenlop.Migrations
{
    ...
    [Migration("20240329154236_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("baitaptrenlop.Models.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("baitaptrenlop.Models.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("baitaptrenlop.Models.Book", b =>
                {
                    b.HasOne("baitaptrenlop.Models.Author", "Author")
                        .WithMany("Books")
